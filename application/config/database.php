...
/**
 * Configuration pour une base de donnée MySQL
 */
$db['default']['hostname'] = 'localhost';
$db['default']['username'] = 'username';
$db['default']['password'] = 'password';
$db['default']['database'] = 'nom_de_base';
...
$db['default']['cachedir'] = '';
$db['default']['char_set'] = 'utf8_general_ci';
...
/**
 * Configuration pour une base de donnée Mssql via ODBC
 */
$db['sqlserver']['hostname'] = 'Driver={SQL Server};'.'Server=nom_du_serveur\instance_de_base;'.'Database=nom_de_base;';
